...
for (int i=0; i< num_particles; i++) {
	cout << "particle weight in main " << particles[i].weight << " particle association " << particles[j].associations.size()endl;
	}
#endif	
//
...
#if ket_debug
for (int i=0; i< num_particles; i++) {
	cout << " particle association " << particles[i].associations.size() <<endl;
	}
#endif	
